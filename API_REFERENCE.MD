...
- Raw HTTP JSON-RPC: 111 Unity Editor methods returned by `list_tools`.
...
Actions: `undo`, `redo`, `play`, `pause`, `step`, `menu`, `read_logs`, `clear_logs`.

### `unity_ui_automation`
Actions: `list_windows`, `get_hierarchy`, `query`, `click`, `input`.
