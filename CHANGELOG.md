...
### Fixed
- `ListPlayerPrefs` now uses `ProcessStartInfo.ArgumentList` for macOS `defaults read` execution, preventing command argument parsing issues from unescaped company or product names in `PlayerSettings` (#143).
