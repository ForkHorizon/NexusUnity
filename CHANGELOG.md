...
### Fixed
- Persist authentication tokens across Unity Editor process restarts in Library and EditorPrefs, preventing persistent HTTP 401 Unauthorized errors for external MCP CLI integrations after restarting Unity (#166).
